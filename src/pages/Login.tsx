  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (result.success && result.user) {
        ...
        console.log(
          `✅ Login realizado como ${userType}: ${result.user.username} (${result.user.role})`
        );
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-950 via-slate-900/50 to-slate-950 relative overflow-hidden p-4 sm:p-6">
      ...
      <div className="relative z-10 w-full max-w-md mx-auto">
        ...
        <div className="bg-gradient-to-br from-slate-800/40 via-slate-800/20 to-slate-900/30 backdrop-blur-md rounded-2xl border border-slate-700/40 shadow-2xl shadow-slate-900/20 p-6 sm:p-10 relative overflow-hidden">
          ...
          <h2 className="text-2xl sm:text-3xl font-black text-white mb-2 mt-12">
            Acesso ao Sistema
          </h2>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div className="text-left flex-1">
                    ...
                    <p className="text-sm text-slate-300">
                      Gerentes, supervisores e administradores
                    </p>
                  </div>
                </div>
              </button>
              ...
              >
                <div className="flex items-center gap-4">
                  ...
                  <div className="text-left flex-1">
                    ...
                    <p className="text-sm text-slate-300">
                      Digite: vigia, vigilante ou guarda
                    </p>
                  </div>
                </div>
              </button>
            ...
            <form onSubmit={handleLogin} className="space-y-5 sm:space-y-6">
              ...
              <div className="flex justify-end -mt-1">
                <button
                  ...
                  className="group flex items-center gap-1.5 text-sm font-medium text-violet-400 hover:text-violet-300 transition-all duration-200 hover:gap-2"
                >
                  <KeyRound className="h-3.5 w-3.5 group-hover:rotate-12 transition-transform" />
                  <span className="relative">
                    Esqueceu a senha?
                    <span className="absolute bottom-0 left-0 w-0 h-px bg-gradient-to-r from-violet-400 to-purple-400 group-hover:w-full transition-all duration-300"></span>
                  </span>
                </button>
              </div>
              ...
              <div className="p-3 rounded-lg bg-blue-950/40 border border-blue-700/30 text-xs text-blue-300">
                ...
                <div className="space-y-1 text-[11px]">
                  {userType === "encarregado" ? (
                    <p>
                      👔 <strong>Encarregado:</strong> teste / 123 ou gerente /
                      gerente@A2005!
                    </p>
                  ) : (
                    <>
                      <p>
                        👁️ <strong>Vigia:</strong> vigia / 123
                      </p>
                      <p>
                        👷 <strong>Vigilante:</strong> vigilante / 123
                      </p>
                      <p>
                        🛡️ <strong>Guarda:</strong> guarda / 123
                      </p>
                    </>
                  )}
                </div>
              ...
              <div className="p-3.5 rounded-lg bg-gradient-to-r from-violet-950/40 to-purple-900/30 border border-violet-700/30">
                <div className="flex items-start gap-2.5">
                  ...
                  <p className="text-xs text-violet-300">
                    Sistema com proteção contra ataques. Após 5 tentativas
                    incorretas, a conta será bloqueada por 15 minutos.
                  </p>
                </div>
              </div>
            ...
            <div className="space-y-3">
              ...
              <div className="bg-slate-900/40 rounded-lg p-3 border border-slate-700/30">
                <p className="text-[11px] text-slate-400 mb-2">
                  <span className="font-bold text-violet-400">admin</span> /
                  adielsonA@2005!
                </p>
                <p className="text-[11px] text-slate-400">
                  <span className="font-bold text-violet-400">gerente</span> /
                  gerente@A2005!
                </p>
              </div>
